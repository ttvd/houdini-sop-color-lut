...
void
SOP_ColorLUTDefaultPalette::GetPalette(UT_Array<UT_Vector3>& palette)
{
    palette.clear();

    for(unsigned int idx = 0; idx < 256u; ++idx)
    {
        union
        {
            struct
        ...
        UT_Vector3 color(SYSclamp(u.r, 0, 255) / 255.0f, SYSclamp(u.g, 0, 255) / 255.0f, SYSclamp(u.b, 0, 255) / 255.0f);
